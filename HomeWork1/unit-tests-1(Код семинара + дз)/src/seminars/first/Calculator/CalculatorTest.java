...
public class CalculatorTest {
    public static void main(String[] args) {
        ...
        /**
          ================================= HomeWork #1 =============================================
         */
        System.out.println(Calculator.calculatingDiscount(5200, 70));
//        System.out.println(Calculator.calculatingDiscount(0, 70));
        System.out.println(Calculator.calculatingDiscount(5200, 99));
        assertThat(Calculator.calculatingDiscount(5200, 70)).isEqualTo(1560);
        assertThat(Calculator.calculatingDiscount(5200, 0)).isEqualTo(5200);
        assertThatThrownBy(() ->
                Calculator.calculatingDiscount(5200, 100)
